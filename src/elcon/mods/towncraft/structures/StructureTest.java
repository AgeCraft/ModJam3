...
public class StructureTest extends Structure {
	...
	public StructureTest(String name) {
		...
		component1.setMinMaxOccurrences(9, 10);
		for(int i = 0; i < 64; i++) {
		...
		component2.setMinMaxOccurrences(9, 10);
		for(int i = 0; i < 120; i++) {
		...
		component2.addAdjacentComponent(ForgeDirection.NORTH, new StructureAdjacentComponent("component3", -3, 0, 0, 0.5F));
		component2.addAdjacentComponent(ForgeDirection.SOUTH, new StructureAdjacentComponent("component1", 0.5F));
		component2.addAdjacentComponent(ForgeDirection.SOUTH, new StructureAdjacentComponent("component3", -3, 0, 0, 0.5F));
		addComponent(component2);
		
		StructureComponent component3 = new StructureComponent("component3");
		component3.setSize(9, 9, 9);
		component3.setMinMaxOccurrences(9, 10);
		for(int i = 0; i < 9; i++) {
			for(int j = 0; j < 9; j++) {
				for(int k = 0; k < 9; k++) {
